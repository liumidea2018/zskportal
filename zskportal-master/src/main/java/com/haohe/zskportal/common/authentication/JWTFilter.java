...
import com.haohe.zskportal.utils.SpringContextUtil;
import com.haohe.zskportal.utils.StringPool;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) throws UnauthorizedException {
        ...
        ZskProperties zskProperties = SpringContextUtil.getBean(ZskProperties.class);
        String[] anonUrl = StringUtils.splitByWholeSeparatorPreserveAllTokens(zskProperties.getShiro().getAnonUrl(), StringPool.COMMA);
