...
import com.haohe.zskportal.common.domain.RedisInfo;
import com.haohe.zskportal.common.exception.RedisConnectException;
import com.haohe.zskportal.common.function.JedisExecutor;
...
/**
 * @author 微笑の掩饰
 * @date 2019/6/27 13:20
 * @description Redis 工具类，只封装了几个常用的 redis 命令，
 *  可根据实际需要按类似的方式扩展即可。
 */
@Service
